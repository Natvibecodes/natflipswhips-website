      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid gap-6 md:grid-cols-3 mt-14">
          <div className="rounded-2xl border border-zinc-700 bg-zinc-900 p-8">
            ...
            <p className="text-gray-400 mt-4">
              Choose the date and appointment time that works best for your
              schedule.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-700 bg-zinc-900 p-8">
            ...
            <h3 className="text-2xl font-bold">We Come To You</h3>

            <p className="text-gray-400 mt-4">
              Home, office, dealership, or job site—we bring everything needed
          ...
          <div className="rounded-2xl border border-zinc-700 bg-zinc-900 p-8">
            ...
            <h3 className="text-2xl font-bold">Enjoy Your Vehicle</h3>

            <p className="text-gray-400 mt-4">
              Leave the hard work to us and enjoy a professionally detailed
              vehicle.
            </p>
          </div>
        </div>
        ...
        <div className="mt-14 rounded-2xl border border-yellow-500 bg-yellow-500/10 p-8 max-w-3xl mx-auto">
          ...
          <p className="text-gray-200 mt-4 text-lg">
            New clients receive{" "}
            <span className="font-bold text-white">$30 OFF</span> their first
            detailing booking.
          </p>
        </div>
        ...
        <p className="text-gray-500 text-sm mt-8 max-w-2xl mx-auto">
          Questions before booking? Scroll down and send us a message—we're
          happy to help you choose the right detailing package.
        </p>
      </div>
    </section>
  );
